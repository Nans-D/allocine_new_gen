 ...
 */
final class Version20240916074110 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE movie_playlists ADD CONSTRAINT FK_CDD318699D86650F FOREIGN KEY (user_id_id) REFERENCES users (id)');
        ...
        $this->addSql('ALTER TABLE user_mood ADD CONSTRAINT FK_79B8E23F9D86650F FOREIGN KEY (user_id_id) REFERENCES users (id)');
